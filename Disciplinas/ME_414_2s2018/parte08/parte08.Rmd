...
Dizemos que os eventos $B_1, B_2, \ldots, B_k$ formam uma partição do espaço amostral $\Omega$ se 
...
A probabilidade do prêmio estar na porta 2 (ou seja, se o jogador trocasse de porta, venceria), dado que o apresentador mostra a porta 3:
