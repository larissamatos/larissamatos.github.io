...
- [Parte 7](Disciplinas/ME_720_2s2019/Parte7.pdf): Estimabilidade em modelos normais lineares.
    ...
    - [Exercício](Disciplinas/ME_720_2s2019/Parte7Ex.pdf): Testes de comparação múltipla.
...
- [Lista 1](Disciplinas/ME_720_2s2019/Lista1.pdf): Modelos Lineares. <span style="color:red"> (Correção dos exercícios 14 e 16. Adição dos exercícios do capítulo 3) </span>
